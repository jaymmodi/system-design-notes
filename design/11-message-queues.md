...
### Kafka Producer (Full Configuration)
...
### Kafka Consumer (Full Configuration)
...
**Exactly-Once:** see "Exactly-once in Kafka" section above.
...
// Alternative: DB UPSERT with natural idempotency key
...
// If lag grows: add consumers (up to partition count), optimize processing, or add partitions
```
